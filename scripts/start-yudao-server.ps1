...
$optionalEnvNames = @(
    ...
    "AI_DOCUMENT_STORAGE_TYPE",
    "AI_DOCUMENT_STORAGE_BASE_PATH",
    "AI_DOCUMENT_MINIO_ENDPOINT",
    "AI_DOCUMENT_MINIO_EXTERNAL_ENDPOINT",
    "AI_DOCUMENT_MINIO_BUCKET",
    "AI_DOCUMENT_MINIO_ACCESS_KEY",
    "AI_DOCUMENT_MINIO_SECRET_KEY",
    "AI_DOCUMENT_MINIO_REGION",
    ...
    "RFQ_PASSWORD_KEY",
    "RFQ_EMAIL_SYNC_ENABLED",
    "RFQ_EMAIL_SYNC_INTERVAL_MILLIS",
    "RFQ_EMAIL_SYNC_INITIAL_DELAY_MILLIS",
    "RFQ_EMAIL_DEFAULT_FOLDER",
    "RFQ_EMAIL_CONNECT_TIMEOUT_MILLIS",
    "RFQ_EMAIL_READ_TIMEOUT_MILLIS",
    "RFQ_EMAIL_MAX_MESSAGES_PER_POLL",
    "RFQ_IMAP_ENABLED",
    "RFQ_IMAP_ACCOUNT",
    "RFQ_IMAP_TENANT_ID",
    "RFQ_IMAP_HOST",
    ...
    "RFQ_IMAP_PASSWORD",
    "RFQ_IMAP_FOLDER",
    "RFQ_IMAP_MAX_MESSAGES_PER_POLL",
    "RFQ_HERMES_MODEL",
    "RFQ_HERMES_SYSTEM_PROMPT",
    "RFQ_HERMES_MAX_INPUT_CHARS",
    "RFQ_HERMES_MAX_TOKENS",
    "RFQ_CLASSIFICATION_MODEL",
    "RFQ_CLASSIFICATION_SYSTEM_PROMPT",
    "RFQ_CLASSIFICATION_MAX_INPUT_CHARS",
    "RFQ_CLASSIFICATION_MAX_TOKENS",
    "RFQ_INTERNAL_EMAIL_DOMAINS",
    "RFQ_INTERNAL_SENDER_KEYWORDS",
    "RFQ_INTERNAL_COMPANY_KEYWORDS",
    "RFQ_INTENT_KEYWORDS"
)
